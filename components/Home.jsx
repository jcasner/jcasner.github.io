    ...
    <div>
      ...
      <div class="wrapper">
        <section>
          ...
          <p>
            I enjoy playing with new technology and will occasionally spin up a project to learn something new. One example of this is a <a href="http://jared.casner.us/EarthDawnDiceRoller/" target="_blank">simple dice roller</a> I wrote for the table top RPG Earthdawn using React Native.
          </p>
        </section>
      </div>
